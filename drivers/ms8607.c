...
bool hsensor_is_connected(void)
{
    ...
    /* Do the transfer */
    i2c_write(118, transfer.address, &transfer.data, transfer.data_length);
...
enum ms8607_status hsensor_write_command_no_stop( uint8_t cmd)
{
    ...
    /* Do the transfer */
//    i2c_status = i2c_master_read_packet_wait(118, read_transfer.address, &read_transfer.data, read_transfer.data_length);;
...
//        return status;
    ...
    i2c_read(118, read_transfer.address, &read_transfer.data, read_transfer.data_length);;
//    if( i2c_status == STATUS_ERR_OVERFLOW )
//        return ms8607_status_no_i2c_acknowledge;
//    if( i2c_status != STATUS_OK)
//        return ms8607_status_i2c_transfer_error;
 ...
 *
 * \param[in] ms8607_pressure_resolut.ion : Resolution requested
 *
 */
